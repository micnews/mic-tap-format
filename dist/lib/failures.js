...
var formatAssertionError = exports.formatAssertionError = function formatAssertionError(line, extraIndent) {
  ...
  output.push('');
  output.push(errorIndent(_chalk2.default.bgGreen('actual') + ' ' + _chalk2.default.bgRed('expected')));
  output.push('');
...
exports.default = function (input$) {
  ...
  input$.failingAssertions$.count().forEach(function (failureCount) {
    ...
    var title = [_chalk2.default.red.bold('Failed Tests:'), 'There ' + past + ' ' + _chalk2.default.red.bold(failureCount) + ' ' + plural].join(' ');
  ...
  _rx2.default.Observable.merge(input$.tests$, input$.failingAssertions$).scan(function (_accum, item) {
    ...
    Object.keys(group).filter(function (number) {
      ...
      set.assertions.forEach(function (assertion) {
        var line = (0, _pad2.default)((0, _pad2.default)((0, _pad2.default)([_chalk2.default.red(_figures2.default.cross + ' ' + assertion.title), '\n', (0, _pad2.default)(''), '\n'].join(' '))));
